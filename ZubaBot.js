 ...
 * THIS BOT WAS BASED ON THE basicBot. See the Credits for more details! 
...
var esBot = {
        ...
        eventUserjoin: function(user){
            ...
            if(known){
                ...
                else var welcome = "Zuba says welcome back, ";
            }
            else{
        ...
        chatUtilities: {        
            ...
            curses: [
                'nigger', 'faggot', 'nigga', 'niqqa','motherfucker','modafocka','bitch','shit','whore','cunt','chode','faggot','lezbo','lesbo','maddafucka','shitbag','asshole'
            ],                        
            beggarSentences: ['fanme','funme','becomemyfan','trocofa','fanforfan','fan4fan','fan4fan','hazcanfanz','fun4fun','fun4fun',
                ...
                'fanmyaccount','fanback','addmeforfan','fans4fan','fans4fan','fanme','bemyfanpls','befanpls','f4f','fanyfan','pleasebemyfan','fan'
            ],
        },
        connectAPI: function(){
            this.proxy = {
                ...
                afklimitCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    else API.sendChat('/me [@' + chat.from + '] N00b Zuba. Try having a correct time limit?');
                                };                              
                        },
                },
                ...
                autowootCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    API.sendChat("/me Download one yourself :/")
                                };                              
                        },
                },
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(space === -1){ 
                                        ...
                                        if (user === false || !user.inRoom) {
                                          return API.sendChat("/em doesn't see '" + name + "' in room. Fine Zuba, you can just eat the cookie.");
                                        } 
                                        else if(user.username === chat.from){
                                            return API.sendChat("/me @" + name +  ", I just facepalmed. Giving cookies to yourself? Greedy much?")
                                        }
                                        else {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(ind > -1){
                                        ...
                                        API.sendChat("/me @" + chat.from + " left roulette. Why?");
                                    }
                                };                              
                        },
                },
                ...
                lockdownCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(esBot.roomSettings.lockdownEnabled){
                                        return API.sendChat("/me [@" + chat.from + "] Zuba might be mad..he's only letting staff chat now.");
                                    }
                ...
                moveCommand: {
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    } else return API.sendChat('/me [@' + chat.from + '] Ugh Zuba, you put in the wrong position.');
                                };                           
                        },
                },
                        ...
                        functionality: function(chat, cmd){
                                ...
                                if( !esBot.commands.executable(this.rank, chat) ) return void (0);
                                    ...
                                    if(lastSpace === msg.indexOf(' ')){
                                        ...
                                        time = msg.substring(lastSpace + 1);
                                        if(isNaN(time)){
                                            return API.sendChat('/me [@' + chat.from + '] Ugh Zuba, you put in an invalid time.');
                                        }
                                        name = msg.substring(cmd.length + 2, lastSpace);
                                    }
                                    var from = chat.from;
