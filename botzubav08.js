...
var esBot = {
        ...
        chatUtilities: {        
            ...
            commandCheck: function(chat){
                ...
                switch(cmd){
                    ...
                    case '!gucci':              esBot.commands.fbCommand.functionality(chat, '!gucci');                             executed = true; break;
        ...
        startup: function(){
            ...
            if(u.permission === 1) return API.chatLog("The bot can't move people when it's run as a bouncer.");
