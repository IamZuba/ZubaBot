...
var esBot = {
        ...
        startup: function(){
            var u = API.getUser();
            if(u.permission < 1) return API.chatLog("Only bouncers and up can run a bot.");
            if(u.permission === 3) return API.chatLog("The bot can't move people when it's run as a bouncer.");
